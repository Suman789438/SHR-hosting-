...
# --- Configuration ---
TOKEN = '8799409107:AAHVQsAqTwvZ1YBGU9TcR8n5rHguf9iiinA'
OWNER_ID = 6492138723
ADMIN_ID = 6492138723
...
def create_main_menu_inline(user_id):
    ...
    if user_id in admin_ids:
        admin_buttons = [
            ...
            types.InlineKeyboardButton('📋 Pending Payments', callback_data='pending_payments_list') # NEW BUTTON
        ]
        ...
        markup.add(admin_buttons[5]) # Added Pending Payments
...
BUTTON_TEXT_TO_LOGIC = {
    ...
    "📋 Pending Payments": _logic_pending_payments_list, # New Text Button Handler
}
